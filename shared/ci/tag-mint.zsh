...
#[why] one masked REPO_PROTECTED_VAR_BOT_TAG_TOKEN per tagging project, terraform-managed, remapped to TAG_TOKEN by the tag-mint job: fail loudly when CI carries none rather than pushing unauthenticated
if [[ -n ${CI:-} ]] {
